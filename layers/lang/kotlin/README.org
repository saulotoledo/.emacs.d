...
* Description
Provides IDE capabilities for Kotlin development using Kotlin Language Server (KLS) and ~kotlin-mode~ with ~dap-mode~ integration.
...
* Keybindings
#+begin_src emacs-lisp
;; Major mode leader bindings for Kotlin
(cfg-keys/leader-def
  "m"     '(:ignore t :which-key "+major-mode")
  "m k"   '(:ignore t :which-key "+kotlin")
  "m k d" '(dap-debug :which-key "Debug Kotlin"))
#+end_src
